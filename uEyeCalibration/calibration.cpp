...
/////////////////////////////
        ...
        case Settings::ASYMMETRIC_CIRCLES_GRID:
            ...
            found = findCirclesGrid( view, s.boardSize, pointBuf, CALIB_CB_ASYMMETRIC_GRID, blobDetector);
            //TODO: it fails here!
            /*
            std::cout << found << std::endl;
            std::cout << s.boardSize << std::endl;
            std::cout << pointBuf << std::endl;
            std::cout << CALIB_CB_ASYMMETRIC_GRID << std::endl;
            */
            break;
        }
        if ( found)                // If done with success, 
        {
            ...
            std::cout << "fck fail: " << image_number <<std::endl;
        }
        image_number++;
